## Try out the v2 alpha [here](https://github.com/andyvorld/LGSTrayBattery/releases/tag/v2.0.0_alpha), with source and readme [here](https://github.com/andyvorld/LGSTrayBattery/tree/v2.0.0_alpha)
# LGS Tray Battery
